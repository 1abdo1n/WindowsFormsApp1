...
namespace WindowsFormsApp1
{
	public class frmLeave : Form
	{
		...
		private void BuildUI()
		{
			...
			// Total card only for Admin / Manager
			...
			// ── Approve / Reject buttons — shown for Admin & Manager ONLY ────
			if (userRole == "Admin" || userRole == "Manager")
			{
				...
				// Position: New | Reject | Approve | Refresh  (right → left)
				toolbar.Resize += (s, e) =>
				{
		...
		private void BtnApprove_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				{
					int approverId = string.IsNullOrEmpty(userId) ? 1 : Convert.ToInt32(userId);
